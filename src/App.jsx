      ...
      <main>
        ...
        >
          <Projects />
                ...
                <section id="blog" className="fade-section">
          <Blog />
        </section>

        <section id="contacts" className="fade-section">
          <Contacts />
        </section>
        ...
        <div className="bot_menu_container">
          <div className={`icon-wrapper ${isOpen ? 'open' : ''}`}>
              ...
              <a href="mailto:giero.gab@gmail.com" target="_blank" rel="noopener noreferrer" title="Gmail">
            ...
            <a href="https://www.instagram.com/giero_904/" target="_blank" rel="noopener noreferrer" title="Instagram">
            ...
            <a href="https://x.com/Giero904" target="_blank" rel="noopener noreferrer" title="Twitter">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://www.facebook.com/Giero34/" target="_blank" rel="noopener noreferrer" title="Facebook">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
